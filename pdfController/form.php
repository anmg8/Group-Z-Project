...
class Form {
   ...
   private $phone = null;
   private $isNew = null;// 
   private $isAdditional = null;//     
   private $isStudentWorker = null;//
   private $ferpaScore = null;
   ...
   public function getFullName(){
	...
	public function setAdmissionAccess($test){
		array_push($this->admisionAccess, $test);
	}
}
