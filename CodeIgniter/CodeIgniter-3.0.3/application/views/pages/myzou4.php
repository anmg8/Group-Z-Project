        ...
        <body>
			...
			<div class="container">
				...
				$rows = array(
					...
					CreateRow("SF General Inquiry",			"gi", "", true, false),
					CreateRow("SF Cash Group Post",			"cg", "", true, true),
					
					CreateRow("FA Cash", 					"fa", "", true, false),
					CreateRow("FA Non Financial Aid Staff",	"as", "", true, false)
				);
				...
				//echo "<h2>Student Records Access</h2>";
				...
				for($i = 0; $i < $rows_count; $i++) {
					...
					if($i >= $next_header)
					{
						...
						<div id="tabs-<?php echo($current_header+1);?>" class="tab-pane fade in active">
					...
					?>
					<p><strong><?php echo $rows[$i]["role"];?>:</strong><?php echo $rows[$i]["description"]; ?></p>
			...
			<?php
				...
				if(isset($_POST['submit'])){
					...
					$staff_member_empl_id = "thingy"; //post_value("staffemplid");
